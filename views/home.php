...
$tank_total_sql = "SELECT COUNT(*) AS tank_total FROM `tank`";
$tank_total = 0;

$result = $conn->query($tank_total_sql);
if ($result->num_rows > 0){
    while ($row = $result->fetch_assoc()){
        $tank_total = $row['tank_total'];
    }
}
                        ...
                        <!--<div class="col-xl-3 col-sm-6 mb-3">
                            <div class="card text-white bg-success o-hidden h-100">
                                <div class="card-body">
                                    ...
                                    <div class="mr-5"><?php /*echo $tank_total; */?> <br> Total Tank Capacity</div>
                                </div>
