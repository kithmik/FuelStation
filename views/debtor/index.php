...
$update_path = "/controllers/deo/debtor/update.php";
$delete_path = "/controllers/deo/debtor/delete.php";
        ...
        <div class="col-md-7 pt-5">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <a href="/views/debtor/create.php" class="btn btn-success">
